...
namespace Yaglot\Client\HttpClient;
    ...
    private function handleCurlError($url, $errno, $message, $numRetries)
    {
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to Yaglot ($url).  Please check your "
                    . "internet connection and try again.  If this problem persists, "
                    . "you should check Yaglot's status at "
                    . "https://twitter.com/yaglot, or";
                break;
            case CURLE_SSL_CACERT:
            case CURLE_SSL_PEER_CERTIFICATE:
                $msg = "Could not verify Yaglot's SSL certificate.  Please make sure "
                    . "that your network is not intercepting certificates.  "
                    . "(Try going to $url in your browser.)  "
                    . "If this problem persists,";
                break;
            default:
                $msg = "Unexpected error communicating with Yaglot.  "
                    . "If this problem persists,";
        }
        $msg .= " let us know at support@yaglot.com.\n\n(Network error [errno $errno]: $message)";
        if ($numRetries > 0) {
